...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  String _formatMonth(DateTime selectedDate) {
                  ...
                  if (snapshot.hasData) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index){
                        ...
                        String recordMonth = DateFormat('MMMM').format(recordDate);
                        return recordMonth == _month ? Container(
